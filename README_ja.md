...
**注意**: このプロジェクトはテキスト→音素変換に[espeak-ng](https://github.com/espeak-ng/espeak-ng)（GPLv3）を使用しています。サードパーティライセンスの詳細は[THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md)を参照してください。
